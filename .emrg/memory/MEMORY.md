...
**㊸ 整页旋转表格页转正（解析 v12）+ ①c 重试 2→20（退避封顶）—— 本地已全验，未上生产**
...
- **待宿主**：①本地跑一次完整转换看浏览器里的并排双语表格（≈100 万 tokens），
  还是直接上生产由宿主自己点「重新提取」；②`08dcd7f`（删死配置）是否随本次一起上。

_Last updated: 2026-09-17T18:35:00+08:00_
